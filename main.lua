...
local Tab = { -- CREATE TABS
    Tab_1 = Window:addTab('#Chính'),
    Tab_Setting = Window:addTab('#Cài đặt'),
    ...
    Tab_5 = Window:addTab('#Trạng Thái và Dịch Chuyển'),
    Tab_6 = Window:addTab('#Cửa Hàng'),
    Tab_7 = Window:addTab('#Khác')
    
}

local Home_Right = Tab.Tab_1:addSection() -- HOME RIGHT SECTION
local Main_Home = Home_Right:addMenu("#Chính")

getgenv().WalkSpeedValue = 26
Main_Home:addTextbox("Hack Tốc Độ", getgenv().WalkSpeedValue, function(speedfunc)
